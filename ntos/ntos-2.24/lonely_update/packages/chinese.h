...
Copyright (C) 1999  Ù¿Ê–√ˆ  Yu Guanghui <ygh@dlut.edu.cn>
...
static void Big2GB(char *, char *, int);
static void GB2Big(char *, char *, int);
static void g2b(unsigned char *);
static void b2g(unsigned char *);
