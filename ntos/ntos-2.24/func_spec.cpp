...
# 1 "packages/arith_operator_spec.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "packages/arith_operator_spec.c"
...
# 33 "./std.h" 2
# 5 "./spec.h" 2
# 3 "packages/arith_operator_spec.c" 2
...
# 33 "./std.h" 2
# 5 "./spec.h" 2
# 3 "packages/mappingbase_spec.c" 2
...
# 33 "./std.h" 2
# 5 "./spec.h" 2
# 2 "packages/moon_spec.c" 2
int milli_clock();
void luan(string);
string hash(string,string);
# 1 "packages/lonely_spec.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "packages/lonely_spec.c"
