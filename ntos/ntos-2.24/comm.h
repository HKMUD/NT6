...
extern long inet_packets;
extern long inet_volume;
#ifdef F_NETWORK_STATS
extern long inet_out_packets;
extern long inet_out_volume;
extern long inet_in_packets;
extern long inet_in_volume;
#ifdef PACKAGE_SOCKETS
extern long inet_socket_in_packets;
extern long inet_socket_in_volume;
extern long inet_socket_out_packets;
extern long inet_socket_out_volume;
#endif
#endif
extern int num_user;
#ifdef F_SET_HIDE
...
#ifdef EPOLL
INLINE void init_epoll (void);
INLINE void flush_user_message (void);
INLINE void flush_lpc_socket (void);
INLINE void process_io (struct epoll_event *);
