...
void create()
{
	set_name("魔龙", ({ "hibernating dragon", "boss","dragon" }) );
	set("race", "龙");
	set("gender", "雄性");
	set("long", "这本是一条在海底修炼的神龙。上古时期叛逃至魔界，也不知道有几千几万年了。 \n");
