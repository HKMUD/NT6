...
{
        command("chat* "+name()+"一拱手道：“良宵一刻值千金，酒不醉人人自醉，今日醉仙楼荣幸地为"+query("name1")+
                "和"+query("name2")+"\n大开喜宴，恭迎各位前来捧场！\n\n");
...
int do_steal(string arg)
{
        ...
        tell_object(me,"你还没搞清楚是什么事，就被一群捕快拖着出了醉仙楼......\n");
...
int kick(object me)
{
        ...
        tell_room("/d/ruzhou/xidajie","突然一个人影从西边的醉仙楼二楼飞出来，“蓬”地重重摔在地上，细看却是一个差点摔死的人。\n");
        set_temp("kick", 1, me);
