...
create_food(string nmstr, string* idlist, string longstr)
{
        ...
        if (longstr)
        set("long", @LONG
进门绕过一道淡红绸屏风，迎面墙上挂着一副『牡丹争艳』图，
牡丹是中国国花，素以富贵著称。图侧对联： 幽径天姿呈独秀，古园
国色冠群芳。衬托了那一茎牡丹分外精神。厅内陈列奢华，正中央一
张雕花楠木青漆嵌玉大圆桌，四周十二张镶银象牙扶手红木椅，杯碗
勺箸，入眼生辉。    这里便是醉仙楼的玫瑰厅，桌上平铺着一份菜
单(menu)。
LONG );
        else
              set("long", GRN+"一盘热气腾腾,香喷喷的"+nmstr+"。\n"+NOR, obj);
