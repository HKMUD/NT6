...
string gift_jingyan()
{
	...
	if (DB_D->query_data("kaifu_huodong/gift_jingyan/count") < 100)
	{
		...
		log_file("gift_jingyan", query("id", me) + " at " + ctime(time()) + "领取经验奖励，排名:" +
                ...
                HISTORY_D->add_history("经验888万排名", query("id", me), sprintf("经验888万，年龄 %d 排名: %d.\n",
...
string gift_neigong()
{
	...
	if (DB_D->query_data("kaifu_huodong/gift_neigong/count") < 100)
	{
		...
		log_file("gift_neigong", query("id", me) + " at " + ctime(time()) + "领取内功奖励，排名:" +
                ...
                HISTORY_D->add_history("内功500级排名", query("id", me), sprintf("内功500级，年龄 %d 排名: %d.\n",
...
string gift_ultra()
{
        ...
        if (DB_D->query_data("kaifu_huodong/gift_ultra/count") < 100)
	{
		...
		log_file("gift_ultra", query("id", me) + " at " + ctime(time()) + "领取宗师奖励，排名:" +
                ...
                HISTORY_D->add_history("评价宗师排名", query("id", me), sprintf("评价宗师，年龄 %d 排名: %d.\n",
...
string gift_pthuiyuan()
{
	...
	if (DB_D->query_data("kaifu_huodong/gift_pthuiyuan/count") < 100)
	{
		...
		me->save();
                ...
                log_file("gift_pthuiyuan", query("id", me) + " at " + ctime(time()) + "领取经验奖励，排名:" +
