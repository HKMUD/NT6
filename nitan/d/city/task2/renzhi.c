...
int do_hit(string arg)
{
        ...
        {
                tell_object(me,HIR"人质正受到"+query("name", gurad_ob)+"的保护，人家加入战斗对你发起攻击！\n"NOR);
                tell_object(gurad_ob,HIR"人质受到"+query("name", me)+"攻击，你挺身加入战斗！\n"NOR);
...
environment()) )
        ...
        {
                tell_object(me,HIR"人质正受到"+query("name", gurad_ob)+"的保护，人家加入战斗抵御你的攻击！\n"NOR);
                tell_object(gurad_ob,HIR+query("name", me)+"准备杀死人质，你挺身加入战斗！\n"NOR);
                me -> kill_ob(gurad_ob);                
                gurad_ob -> fight_ob(me);
                return 1;
        }
...
int do_touxi(string arg)
{
        ...
        {
                tell_object(me,HIR"人质正受到"+query("name", gurad_ob)+"的保护，人家加入战斗抵御你的攻击！\n"NOR);
                tell_object(gurad_ob,HIR+query("name", me)+"准备对人质进行偷袭，你挺身加入战斗！\n"NOR);
                me -> kill_ob(gurad_ob);
                gurad_ob -> fight_ob(me);
                return 1;
        }
...
int do_order(string arg)
{
        ...
        if (act == "go")
        {
                ...
                //目的地到达
                        ...
                        message("channel:chat",HIM"【谣言】听说"+query("name", me)+"成功将人质护送到目的地了！\n"NOR,users());
