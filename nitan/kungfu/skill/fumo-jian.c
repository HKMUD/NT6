...
([        "action" : "$N回身拧腰，右手虚抱成圆，一式"HIW"「开天势」"NOR"，$w中宫直进，刺向$n的胸口",
        "lvl" : 40,
        "skill_name" : "开天势"
]),
([        "action" : "$N一式"BLU"「劈地势」"NOR"，$w从上至下猛劈，剑锋直出，挟爆裂之声骤然斩向$n的$l",
        "lvl" : 49,
        "skill_name" : "劈地势"
]),
([        "action" : "$N运气施出"MAG"「雷针势」"NOR"，$w剑尖逼出一道青芒，闪电般破空射向$n的$l",
        "lvl" : 57,
        "skill_name" : "雷针势"
]),
([        "action" : "$N双腿半屈半蹲，一式"GRN"「龙吞势」"NOR"，剑尖划出无数圆圈，狂风骤起，笼罩天地",
        "lvl" : 64,
        "skill_name" : "龙吞势"
]),
});
