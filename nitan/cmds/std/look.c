...
int look_item(object me, object obj)
{
            ...
            mapp(query("armor_prop", obj)) )
        {
                ...
                if( query("require/level", obj) ) str += HIW "装备要求 : 等级 Lv." + query("require/level", obj) + "\n" NOR;
                if( query("require/int", obj) ) str += HIW "装备要求 : 灵性 " + query("require/int", obj) + "\n" NOR;
                ...
                if( query("require/dex", obj) ) str += HIW "装备要求 : 敏捷 " + query("require/dex", obj) + "\n" NOR;
