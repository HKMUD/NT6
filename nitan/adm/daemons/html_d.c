...
void create_mudlist_html()
{
        ...
        text += "<P>　以下列出目前大陆大部份已知的泥巴 <ACRONYM title=泥巴游戏>MUD</ACRONYM>"; 
        text += "的即时列表，并侦测连线状况与线上玩家人数供各位参考，若您想推荐某个中文泥巴站台，请用Zmud登录游戏 muds.cn 5000 与 Lonely 联系。</P>";
        text += "<UL><LI class=level1><DIV class=li>若您的网页浏览器支持 JavaScript ，按栏位可依选择排序。</DIV>";
        text += "<LI class=level1><DIV class=li>上线人数 N/A 为系统无从得知此间 <ACRONYM title=泥巴游戏>MUD</ACRONYM> 之人数。</DIV></LI></UL><P>";
        ...
        text += "<A name=中文泥巴玩家分布状况></A>";
        text += "<DIV style='BORDER-BOTTOM: #aaa 3px double; WIDTH: 200px; COLOR: #333; FONT-SIZE: 16px'><IMG src='muds/mudlist/subtitle.gif'>中文泥巴玩家分布状况</DIV><BR>";
        text += "<P><CENTER><IMG src='muds/mudlist/chart.png'></CENTER>";
            
        text += "<P></P><!-- SECTION [3358-4159] --><A name=中文泥巴玩家即时统计></A>";
        text += "<DIV style='BORDER-BOTTOM: #aaa 3px double; WIDTH: 200px; COLOR: #333; FONT-SIZE: 16px'><IMG src='muds/mudlist/subtitle.gif'>中文泥巴玩家即时统计</DIV><BR>";
        ...
        make_html(text, (["filename":"/www/mudlist.html", "title":"中文泥巴列表", "fontsize":15, "fontface":"宋体"]));
}
