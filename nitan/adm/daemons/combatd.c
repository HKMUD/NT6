...
varargs int do_attack(object me, object victim, object weapon, int attack_type, int flag)
{
         ...
         * 如果#define USE_SKILLS_COMBAT则为采用第一套，否则视为采用第二套，本游戏采用第一套
         */
        fight = ([]);
        ...
        if( array_flag || query_temp("freeze", victim) ) dp = 0;          // 替人挡招只能招架或者在冰冻状态躲闪为0
        else {
        ...
        //
                ...
                if( query_temp("freeze", victim) ) pp = 0;  // 冰冻状态招架为0
                else {
        ...
        //
                        ...
                        if( damage > 0 ) {
                                ...
                                */
                                ...
                                // 发挥勋章--碧海残镢的作用
                                if( objectp(ob = query_temp("armor/charm", me)) && ob->query_magic_item() == "碧海残镢" )
                                {
