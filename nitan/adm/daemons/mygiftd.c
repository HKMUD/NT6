...
mapping gift_list = ([
        ...
        "3"   :   ([ "达成条件" : "在线2分钟",
                     ...
                     "条件数值" : 120,
                     "条件描述" : "在线达到两分钟",
                     "奖励描述" : "/clone/goods/zhufu_armor:1,/clone/gift/xiandan:8",
                     "下个奖励" : "4", ]),
        ...
        "4"   :   ([ "达成条件" : "查看新闻",
                     ...
                     "奖励描述" : "/clone/goods/zhufu_head:1,/clone/gift/xisuidan:8",
                     "下个奖励" : "5", ]),
        ...
        "5"   :   ([ "达成条件" : "阅读文选",
                     ...
                     "奖励描述" : "/clone/goods/zhufu_waist:1,/clone/gift/shenliwan:8",
                     "下个奖励" : "6", ]),
        ...
        "6"   :   ([ "达成条件" : "查看 msg 功能",
                     ...
                     "奖励描述" : "/clone/goods/zhufu_wrists:1,/clone/gift/unknowdan:8",
                     "下个奖励" : "7", ]),
        ...
        "7"   :   ([ "达成条件" : "查询新手导师",
                     ...
                     "奖励描述" : "/clone/goods/zhufu_surcoat:1,/clone/item/magicfruit:8",
                     "下个奖励" : "8", ]),
        ...
        "10"  :   ([ "达成条件" : "闯荡江湖",
                     "条件标识" : "newbie_quest_completed/can_out",
                     "条件数值" : 1,    
                     "条件描述" : "从古村离开（完成所有古村任务并离开）\n" 
                                  HIR "              提示：根据导师--老村长的提示先完成古村任务后才能出村。\n"
                                      "              在世界之树输入指令" HIY "ask lao 出村" HIR "，根据提示完成任务才能出村。\n" NOR,
                     "奖励描述" : "/clone/goods/dizangshi:1,pot:50000,riding:100,training:100,fuzhong:1",
                     "下个奖励" : "12", ]),
        ...
        "12"  :   ([ "达成条件" : "制造如意乾坤袋",
                     ...
                     "奖励描述" : "/clone/fam/gift/int3:3,gold:2",
                     "下个奖励" : "14", ]),
        ...
        "14"  :   ([ "达成条件" : "与魔幻兽签订血之盟约",
                     ...
                     "奖励描述" : "/clone/fam/gift/str3:3,horse:1",
                     "下个奖励" : "16", ]),
        ...
        "20"  :   ([ "达成条件" : "了解 bug 回报",  
                     ...
                     "奖励描述" : "/clone/goods/study-emblem:1",
                     "下个奖励" : "25", ]),     
        ...
        "45"  :   ([ "达成条件" : "造访海龟",
                     ...
                     "条件数值" : 1,
                     "条件描述" : "造访一下新手练功法宝海龟\n" 
                                  HIR "              提示：输入"HIY"rideto"HIR"查看骑马可到达地方，然后"HIY"do rideto nanhai,n,e"HIR"前往。" NOR,
        ...
        "50"  :   ([ "达成条件" : "造访神雕",
                     ...
                     "条件数值" : 1,
                     "条件描述" : "造访新人练功法宝神雕\n" 
                                  HIR "              提示：输入"HIY"rideto"HIR"查看骑马可到达地方，然后"HIY"rideto shendiao"HIR"前往。" NOR,
        ...
        "85"  :   ([ "达成条件" : "装备签名",
                     ...
                     "条件数值" : 1,
                     "条件描述" : "是时候拥有一把属于自己的装备了，装备签名说明参见help weapon", 
        ...
        "95"  :  ([ "达成条件" : "博学多才（一）",
                     ...
                     "条件数值" : 1,
                     "条件描述" : "学习镶嵌技艺到一百级\n" 
                                  HIR "              提示：到鲁班处学习，指令"HIY"xue lu ban certosina"HIR"学习。" NOR,
        ...
        */
        ...
        "200"  :  ([ "达成条件" : "等待下一个挑战", // 这个版本开发至此，后续开发则从这里开始
