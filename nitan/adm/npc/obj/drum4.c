                ...
                if (query("loop"))
                {
                        ...
                        if (stringp(query("drum_knocked")))
                        {
                                ...
                                if (no1)
                                {
                                        ...
                                        HISTORY_D->add_history("华山论剑", query("id", no1), sprintf("战神组 %s(%s)，年龄 %d、等级 %d，荣获名次 1.\n", 
                                ...
                                if (no2)
                                {
                                        ...
                                        HISTORY_D->add_history("华山论剑", query("id", no2), sprintf("战神组 %s(%s)，年龄 %d、等级 %d，荣获名次 2.\n", 
                                ...
                                if (no3)
                                {
                                        ...
                                        HISTORY_D->add_history("华山论剑", query("id", no3), sprintf("战神组 %s(%s)，年龄 %d、等级 %d，荣获名次 3.\n", 
